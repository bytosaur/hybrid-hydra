...
solid()
.add(vcoComp(520/60).mask(shape(4,.25,0).scrollX(0.25).pixelate(3,1) ) )
.add(vcoComp(300/60).mask(shape(4,.25,0).scrollX(0.00).pixelate(3,1) ) )
.add(vcoComp(870/60).mask(shape(4,.25,0).scrollX(-0.25).pixelate(3,1) ) )
